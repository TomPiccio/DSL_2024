...
HD_PWD='D:/Documents/Term 6/Digital Systems Lab/Week_2/b3logic1/b3logic1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log b3logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source b3logic.tcl
