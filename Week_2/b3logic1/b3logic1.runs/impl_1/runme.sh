...
HD_PWD='D:/Documents/Term 6/Digital Systems Lab/Week_2/b3logic1/b3logic1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log b3logic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source b3logic.tcl -notrace
