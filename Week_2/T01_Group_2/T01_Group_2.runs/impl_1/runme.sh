...
HD_PWD='D:/Documents/Term 6/Digital Systems Lab/Week_2/T01_Group_2/T01_Group_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log T01_Logic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source T01_Logic.tcl -notrace
