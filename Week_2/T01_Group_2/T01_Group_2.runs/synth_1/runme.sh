...
HD_PWD='D:/Documents/Term 6/Digital Systems Lab/Week_2/T01_Group_2/T01_Group_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T01_Logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T01_Logic.tcl
