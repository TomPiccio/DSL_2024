...
HD_PWD='D:/Documents/Term 6/Digital Systems Lab/NOR/NOR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nor_rs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nor_rs.tcl
