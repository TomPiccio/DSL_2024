...
HD_PWD='D:/Documents/Term 6/Digital Systems Lab/NOR/NOR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nor_rs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nor_rs.tcl -notrace
